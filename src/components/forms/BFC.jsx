...
// export const UpdateVenueForm = ({ residence }) => {
//   const { id } = residence;
//   const [mediaArray, setMediaArray] = useState(residence?.media || []);
...
//       media: mediaArray,
//       price: residence?.price || 1,
//       maxGuests: residence?.maxGuests || 1,
//       meta: {
//         wifi: residence?.meta.wifi || false,
//         parking: residence?.meta.parking || false,
//         breakfast: residence?.meta.breakfast || false,
//         pets: residence?.meta.pets || false,
//       },
//       location: {
//         address: residence?.location.address || "",
//         city: residence?.location.city || "",
//         zip: residence?.location.zip || "",
//         country: residence?.location.country || "",
//         continent: residence?.location.continent || "",
//       },
//     },
